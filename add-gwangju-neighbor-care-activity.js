/**
 * 이웃돌봄(광주 세나뚜스) 종목·세목 추가
 * 활동요약: 죽을 위험 중의 세례(명), 세례보충예식(명)
 * 사용: node add-gwangju-neighbor-care-activity.js [--render]
 */
...
const ITEMS = [
    { item: '비신자 환자 방문 및 돌봄', desc: '비신자 환자 방문·돌봄 (광주)' },
    { item: '비신자 상가방문 및 돌봄', desc: '비신자 상가 방문·돌봄 (광주)' },
    { item: '병원 방문 및 활동', desc: '병원 방문·활동 (광주)' },
    { item: '복지시설 노력 봉사', desc: '복지시설 노력 봉사 (광주)' },
    { item: '재해 및 사고 피해자', desc: '재해·사고 피해자 돌봄 (광주)' }
];
