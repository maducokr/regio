                ...
                <div class="regio-help-body" id="regioHelpBody">
                    ...
                    <section class="regio-help-section" id="help-login">
                        ...
                        <ol class="regio-help-steps">
                            ...
                            <li>직책: 단장 G1 · 부단장 G2 · 서기 G3 · 회계 G4 · 행동단원 G5 · 협조단원 G6 · 쁘레또리운 G7 · 아듀또리움 G8 · 예비단원 G9 · 휴가 G10</li>
                        </ol>
                        <h4>③ 비밀번호</h4>
                    ...
                    <section class="regio-help-section" id="help-signup">
                        ...
                        <ol class="regio-help-steps">
                            ...
                            <li>직책을 선택한 뒤 <strong>성명+숫자4자리</strong>를 ID로 입력합니다. (G1~G10는 자동 적용)</li>
                            <li>등록 Gmail 주소로 <strong>인증발송 → 인증코드 입력 → 인증확인</strong>을 완료합니다. (미인증 시 가입 불가)</li>
                            <li>세례명, 성별, 성당, Pr, (해당 시) 꾸리아, <strong>세나뚜스(서울·광주·대구·LA·뉴욕·필라델피아·세계·토론토·몬트리올·브라질·아르헨·파리·마드리드·바르셀로나·빌바오)</strong>, 비밀번호(특수문자+영문3+숫자4, 예: @abc1234)를 입력합니다.</li>
                    ...
                    <section class="regio-help-section" id="help-menu">
                        ...
                        <table class="regio-help-table">
                            ...
                            <tbody>
                                ...
                                <tr><td>Pr 보고</td><td>월례보고/사업보고 (광주 세나뚜스는 부산·제주·광주(전주)·마산 중 선택 후)</td><td>로그인</td></tr>
                    ...
                    <section class="regio-help-section" id="help-activity-report">
                        ...
                        <ul>
                            ...
                            <li><strong>Pr 보고</strong>: <em>월례보고</em> 또는 <em>사업보고</em> (광주 세나뚜스만 교구 <em>부산·제주·광주(전주)·마산</em> 선택 후)</li>
