/**
 * 영성생활(광주 세나뚜스) 종목·세목 추가
 * 활동요약: 횟수(회,단,회,분)
 * 사용: node add-gwangju-spiritual-life-activity.js [--render]
 */
...
const ITEMS = [
    { item: '평일 미사', desc: '평일 미사 (광주)' },
    { item: '묵주 기도', desc: '묵주 기도 (광주)' },
    { item: '십자가의 길', desc: '십자가의 길 (광주)' },
    { item: '성경 봉독, 쓰기', desc: '성경 봉독·쓰기 (광주)' },
    { item: '소성무일도', desc: '소성무일도 (광주)' },
    { item: '기타', desc: '기타 영성생활 (광주)' }
];

const FIELDS = [
    { name: '횟수', display: '횟수(회,단,회,분)', required: false }
];
