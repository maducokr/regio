/**
 * 교우돌봄(광주 세나뚜스) 세목 추가
 * 세목: 교우 상가 방문 및 돌봄, 교우 환자 방문 및 돌봄
 * 활동요약: 연도(명), 장례미사(고별식)(명), 기타 상가 활동(명), 횟수
 * 사용: node add-gwangju-believer-care-activity.js [--render]
 */
...
const ITEMS = [
    { item: '교우 상가 방문 및 돌봄', desc: '교우 상가 방문·돌봄 (광주)' },
    { item: '교우 환자 방문 및 돌봄', desc: '교우 환자 방문·돌봄 (광주)' }
];

const FIELDS = [
    { name: '연도', display: '연도', required: false },
    { name: '장례미사(고별식)', display: '장례미사(고별식)', required: false },
    { name: '기타 상가 활동', display: '기타 상가 활동', required: false },
