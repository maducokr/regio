/**
 * 환경보호(광주 세나뚜스) 종목·세목 추가
 * - 환경보호-개인적인 실천 활동 및 권유
 * - 환경보호-공동체적인 활동
 * - 환경보호-교육, 기타
 * 활동요약: 횟수
 * 사용: node add-gwangju-env-protection.js [--render]
 */
...
const ITEMS = [
    { item: '개인적인 실천 활동 및 권유', desc: '개인적인 실천 활동 및 권유 (광주)' },
    { item: '공동체적인 활동', desc: '공동체적인 활동 (광주)' },
    { item: '교육, 기타', desc: '교육, 기타 (광주)' }
];
