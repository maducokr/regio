...
(function (global) {
    ...
    const ACTIVITY_MATTERS_PART1 = [
        {
            ...
            rows: [
                ...
                { label: '3. 교리중단자권면', categories: ['복음선교-교리 중단자 권면'], remarks: [{ label: '교리반인도', field: 'catechism_guide', unit: '명' }] },
                { label: '4. 방문선교', categories: ['입교권면-방문선교', '복음선교-방문선교'], remarks: [{ label: '교리반인도', field: 'catechism_guide', unit: '명' }] },
                { label: '5. 가두선교', categories: ['복음선교-가두선교'], remarks: [{ label: '자기소개서', field: 'catechism_guide', unit: '건' }] },
                { label: '6. 교리반봉사', categories: ['예비신자 돌봄-교리반 봉사', '입교권면-교리반 인도', '복음선교-교리반 인도', '입교권면-교리반인도예비자', '복음선교-교리반인도예비자', '복음선교-교리반 인도 예비신자 돌봄'], remarks: [{ label: '세례자', field: 'baptism', unit: '명' }] },
                { label: '7. 예비신자돌봄', categories: ['예비신자 돌봄-예비신자 돌봄', '입교권면-예비신자관리돌봄', '복음선교-예비신자관리돌봄', '복음선교-타인이 인도한 예비신자 돌봄'], remarks: [{ label: '세례자', field: 'baptism', unit: '명' }] },
                { label: '8. 통신교리자돌봄', categories: ['예비신자 돌봄-통신교리자 돌봄', '입교권면-통신교리자 돌봄', '복음선교-통신교리자 돌봄', '복음선교-통신교리자돌봄'], remarks: [{ label: '세례자', field: 'baptism', unit: '명' }] },
                { label: '9. 교리반협조', categories: ['입교권면-교리반협조', '복음선교-교리반협조', '복음선교-교리반 봉사 및 협조'], remarks: [] }
            ]
        },
        {
            title: '2. 교우돌봄',
    ...
    const ACTIVITY_MATTERS_PART2 = [
        ...
        },
        {
            ...
            rows: [
                ...
                { label: '6. 차량봉사 및 교통정리', categories: ['기타활동-차량봉사및교통정리', '기타-차량봉사', '기타-교통정리'], remarks: [] },
                { label: '7. 기타', categories: [
                    '기타활동-기타', '기타활동-기타교구행사참석', '본당교회협조-기타본당협조',
                    '기타-성지 미화작업', '기타-무연묘벌초', '기타-성지정리작업',
                    '기타-생명존중활동(헌혈,장기기증,자살예방,낙태반대...)'
                ], remarks: [] }
            ]
        }
    ];
            ...
            items: [
                {
                    ...
                    unit: '명',
                    categories: [
                        '입교권면-외인 입교권면', '복음선교-외인 입교권면', '복음선교-개종권면', '복음선교-교리 중단자 권면',
                        '입교권면-방문선교', '복음선교-방문선교', '복음선교-가두선교'
                    ],
                ...
                },
                {
                    ...
                    categories: [
                        ...
                        '입교권면-교리반 인도', '복음선교-교리반 인도', '입교권면-교리반인도예비자', '복음선교-교리반인도예비자',
                        '입교권면-예비신자관리돌봄', '복음선교-예비신자관리돌봄', '입교권면-통신교리자 돌봄', '복음선교-통신교리자 돌봄'
                    ],
                    resultField: 'baptism'
                }
            ]
    ...
    /** 대구 꾸리아 종합보고 활동 세목 집계 (Pr 월례와 동일 유사매칭) */
    function computeDaeguCompActivity(records) {
        ...
        const parishCatechism = one((n) => /본당협조활동.*첫영성체|교리반|첫영성체\s*교리반/.test(n), 'catechism_guide')
            || one((n) => /교리반\s*인도|교리반인도/.test(n));
        ...
        const gospelMeditation = one((n) => /복음묵상|미사\s*전\s*독서|미사전\s*독서|독서.*복음/.test(n));
        const bibleWrite = one((n) => /상급평의회가\s*지시한\s*활동/.test(n), 'catechism_guide')
            || one((n) => /성경필사|성경\s*쓰기|성경쓰기|필사/.test(n));
        const magazine = one((n) => /성모님의\s*군단|빛잡지|빛\s*잡지/.test(n));
        const meetingMass = one((n) => /주회\s*전후\s*미사|주회합.*미사/.test(n));
        const weekdayMass = one((n) => /평일미사/.test(n));
        const higherOther = one((n) => /상급평의회\s*지시|상급.*지시|기타\s*상급평의회/.test(n));
        ...
        return {
            ...
            parishOps, firstCommunionLead, firstCommunionBaptism, parishCatechism,
            legionGrow, activeRecruit, auxRecruit,
            smallCommunity, nature, higherCouncil,
            bibleRead, gospelMeditation, bibleWrite, magazine, meetingMass, weekdayMass, higherOther, rosary,
            otherAct
        };
    }
