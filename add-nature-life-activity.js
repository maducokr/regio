/**
 * 자연보호 및 생명존중 운동에 동참 종목·세목 추가
 * 활동요약: 횟수
 * 사용: node add-nature-life-activity.js [--render]
 */
...
const GROUP = '자연보호 및 생명존중 운동에 동참';

const ITEMS = [
    { item: '생태환경 운동 실천', desc: '생태환경 운동 실천' },
    { item: '낙태반대운동 참가', desc: '낙태반대운동 참가' },
    { item: '사후 장기기증운동 동참', desc: '사후 장기기증운동 동참' },
    { item: '헌혈', desc: '헌혈' },
    { item: '헌혈권유', desc: '헌혈 권유' }
];
