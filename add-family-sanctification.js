// 가정성화활동 신규 활동종목 4개를 실제 DB에 반영하는 스크립트
// - 가족이함께기도하기, 성경봉독 및 묵상, 미사참례, 가족단위 복지시설봉사
// - 각 종목 입력필드: 횟수(회,단,시간)
...
const GROUP = '가정성화활동';
const NEW_ITEMS = [
    { name: '가정성화활동-가족이함께기도하기', desc: '가족이 함께 기도하기' },
    { name: '가정성화활동-성경봉독 및 묵상', desc: '성경봉독 및 묵상' },
    { name: '가정성화활동-미사참례', desc: '가족 미사참례' },
    { name: '가정성화활동-가족단위 복지시설봉사', desc: '가족단위 복지시설 봉사' },
];
