...
const pool = new Pool({
    ...
    max: 2,
    application_name: 'regio-outdoor-assign'
});
...
async function main() {
    ...
    try {
        ...
        console.log(`기존 야외행사 기록 삭제: ${deleted.rowCount}건`);
        ...
        for (const g of groups.rows) {
            ...
            const eventDate = randomDate2025();
