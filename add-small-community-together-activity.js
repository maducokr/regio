/**
 * 소공동체와 함께하는 활동 종목·세목 추가
 * 활동요약: 횟수
 * 사용: node add-small-community-together-activity.js [--render]
 */
...
const GROUP = '소공동체와 함께하는 활동';

const ITEMS = [
    { item: '소공동체 모임 참석', desc: '소공동체 모임 참석' },
    { item: '소공동체 모임 참석 권유', desc: '소공동체 모임 참석 권유' },
    { item: '소공동체 회의 참석', desc: '소공동체 회의 참석' },
    { item: '소공동체 교육 참석', desc: '소공동체 교육 참석' }
];
