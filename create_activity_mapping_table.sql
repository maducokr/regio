...
('본당교회협조-소공동체활동', '횟수', '횟수(회,단,시간)', true),
('본당교회협조-사무협조', '횟수', '횟수(회,단,시간)', true),
('본당교회협조-회원모집', '횟수', '횟수(회,단,시간)', true),
('본당교회협조-전례협조', '횟수', '횟수(회,단,시간)', true),
('본당교회협조-피정참가권장', '횟수', '횟수(회,단,시간)', true),

-- 기타
('기타-출판물 보급', '횟수', '횟수(회,단,시간)', true),
('기타-자연보호', '횟수', '횟수(회,단,시간)', true),
('기타-특별활동', '횟수', '횟수(회,단,시간)', true),
('기타-접촉활동', '횟수', '횟수(회,단,시간)', true),
('기타-청소 미화', '횟수', '횟수(회,단,시간)', true),
('기타-차량봉사및교통정리', '횟수', '횟수(회,단,시간)', true),
('기타-기타', '횟수', '횟수(회,단,시간)', true)
